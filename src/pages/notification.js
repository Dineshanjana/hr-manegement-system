        ...
        <div className="n-main">
            <div className="n-header">
                ...
                <div className="n-tabs">
                    ...
                    <button
                        className={`n-tab ${activeTab === 'unread' ? 'active' : ''}`}
                        onClick={() => setActiveTab('unread')}
                    >
                        Unread
                    </button>
                    <button
                        className={`n-tab ${activeTab === 'archive' ? 'active' : ''}`}
                    ...
                    filteredNotifications.map(notification => (
                        <div key={notification.id} className="n-item">
                            ...
                            <div className="n-actions">
                                ...
                                <button className="n-btn respond" onClick={() => handleRespond(notification.id)}>Respond</button>
                            </div>
                        </div>
                    ))
                )}
